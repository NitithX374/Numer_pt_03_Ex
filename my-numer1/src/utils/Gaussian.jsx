...
const GaussianCalculator = () => {
    ...
    const calculateGaussian = () => {
        try {
            ...
            // Gaussian elimination to convert the matrix to RREF
            for (let i = 0; i < n; i++) {
                // Pivot by making the diagonal 1
                ...
                // Make all elements in current column 0 except pivot
                for (let k = 0; k < n; k++) {
                    if (k !== i) {
